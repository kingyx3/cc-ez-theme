...
- OTP platform-ownership, login redirect, and purchase-limit-after-login regression suites, which serve their own pages and so run even when the storefront is unreachable
